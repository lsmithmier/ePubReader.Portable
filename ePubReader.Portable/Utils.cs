...
namespace eBdb.EpubReader {
	public class Utils {
		...
		public static readonly RegexOptions REO_c = RegexOptions.None | REO_;
		public static readonly RegexOptions REO_s = RegexOptions.Singleline | REO_;
		public static readonly RegexOptions REO_cs = RegexOptions.None | REO_s;
		public static readonly RegexOptions REO_m = RegexOptions.Multiline | REO_;
		public static readonly RegexOptions REO_cm = RegexOptions.None | REO_m;
		...
		public static readonly RegexOptions REO_csi = RegexOptions.None | REO_si;
		public static readonly RegexOptions REO_mi = RegexOptions.Multiline | REO_i;
		public static readonly RegexOptions REO_cmi = RegexOptions.None | REO_mi;
